...
G-Pilot is a full-stack, multi-agent security automation system that scans GitHub repositories, validates findings in an isolated Docker sandbox, applies remediation, and re-tests the result before optionally opening a pull request.
...
- The webhook path is handled in **backend/vuln_swarm/api/app.py**.
